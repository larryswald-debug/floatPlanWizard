...
<head>
  ...
  <title>Admin Operator Manager</title>
...
<body>
  <div class="wrap">
    ...
    <cfelse>
      <div id="adminOperatorMessage" class="msg"></div>

      <form id="adminOperatorFilters" novalidate>
        <div class="toolbar">
          <div class="field">
          ...
          <div class="field">
            <label for="filterSearch">Operator Search</label>
            <input type="text" id="filterSearch" placeholder="name, phone, notes">
          </div>
          <div class="field">
      ...
      <div class="summary-line">
        <div id="operatorSummaryLine">Loading operators...</div>
      </div>
  ...
  <cfif isAuthorized>
    <div class="modal fade" id="adminOperatorModal" tabindex="-1" aria-labelledby="adminOperatorModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="adminOperatorModalLabel">Operator</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <form id="adminOperatorForm" novalidate>
              <input type="hidden" id="modalOperatorId" value="0">
              <div class="small-muted mb-2" id="modalOwnerModeHint">Owner can only be set when creating an operator.</div>
              ...
              <div class="row row-gap mt-1">
                <div class="col-md-9">
                  <label class="form-label" for="modalOperatorName">Operator Name *</label>
                  <input type="text" class="form-control" id="modalOperatorName" required>
                </div>
                <div class="col-md-3">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" id="saveOperatorBtn">Save Operator</button>
          </div>
        </div>
      </div>
    </div>
