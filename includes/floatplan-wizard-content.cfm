<cfparam name="wizardShellClasses" default="wizard-shell">
<cfparam name="wizardAutoInit" default="false">
<cfoutput>
<div class="#wizardShellClasses#">
<header class="wizard-header">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="/fpw/app/dashboard.cfm" class="btn btn-outline-light btn-sm wizard-back-link">Back to Dashboard</a>
        </div>
    </div>
</header>

<main>
    <div id="wizardApp" class="wizard-container" data-auto-init="#wizardAutoInit#">
