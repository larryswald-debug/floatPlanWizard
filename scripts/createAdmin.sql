INSERT INTO FPW.member_entitlements
    (user_id, entitlement_type, source, grant_kind, status,
     starts_at_utc, expires_at_utc, revoked_at_utc, admin_notes)
SELECT
    u.userId,
    'admin',
    'manual_admin',
...
WHERE u.userId = 1
  AND NOT EXISTS (
      ...
      WHERE me.user_id = u.userId
        ...
        AND (
            me.expires_at_utc IS NULL
            OR me.expires_at_utc > UTC_TIMESTAMP()
        )
  );