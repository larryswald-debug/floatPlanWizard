...
<cfset expectedConfirmation = "RUN_DISPOSABLE_OPERATIONAL_ROUTE_GEOMETRY_TESTS">
<cfset fixturePattern = "codex-operational-route-geometry-%">
...
<cftry>
  <cfset runner = createObject("component", "testbox.system.TestBox").init(
    bundles = "fpw.tests.specs.OperationalRouteGeometrySnapshotSpec"
  )>
