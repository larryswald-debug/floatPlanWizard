...
<cfset expectedConfirmation = "RUN_INACTIVE_MEMBER_RECOVERY_CLASSIFIER_TESTS">
...
<cftry>
  <cfset testbox = new testbox.system.TestBox(bundles="fpw.tests.specs.InactiveMemberRecoveryClassifierSpec")>
  ...
  <cfcatch type="any">
    ...
    <cfcontent type="application/json; charset=utf-8" reset="true">
    <cfoutput>#serializeJSON({SUCCESS=false,ERROR="CLASSIFIER_TEST_RUNNER_FAILED",TYPE=cfcatch.type,MESSAGE=cfcatch.message})#</cfoutput>
  </cfcatch>
</cftry>
