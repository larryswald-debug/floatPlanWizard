...
<cfset expectedConfirmation = "RUN_DISPOSABLE_ROUTE_CONTINUITY_TESTS">
<cfset fixturePattern = "codex-route-continuity-%">
...
<cftry>
  <cfset runner = createObject("component", "testbox.system.TestBox").init(
    bundles="fpw.tests.specs.RouteContinuitySpec"
  )>
