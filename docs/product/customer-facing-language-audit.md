...
| F067 | Medium | Free-trip ambiguity | Homepage | `partials/fpw-conversion-landing.cfm` | 221-224 | “First Premium trip for eligible new members” | The included trip may be what unlocks the listed Route Builder and saved planning tools. | Planning is independently free; the card mixes planning and complimentary paid capability. | Planning access does not consume the credit. | Separate free planning from the included send-and-monitor transaction. |
