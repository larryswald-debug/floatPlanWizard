        ...
        <div class="fpw-preview-shell" data-preview-asset-base="<cfoutput>#landingBasePath#</cfoutput>/assets/images/home/">
          <div class="fpw-preview-head">
            ...
            <div class="fpw-tabs" role="tablist" aria-label="FloatPlanWizard product preview">
              ...
              <button class="fpw-tab" id="fpw-preview-tab-route" type="button" role="tab" aria-selected="false" aria-controls="fpwPreviewPanel" data-preview-tab="route" data-fpw-track="homepage_demo_tab_click" data-fpw-track-label="Route Generator" data-fpw-track-section="product_demo">Trip Planner</button>
