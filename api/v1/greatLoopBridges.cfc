<cfcomponent output="false" hint="Public Great Loop bridge library JSON API.">

  <cffunction name="handle" access="remote" returntype="void" output="true">
    <cfargument name="action" type="string" required="false" default="">
    <cfargument name="q" type="string" required="false" default="">
    <cfargument name="routeSegment" type="string" required="false" default="">
    <cfargument name="routeVariant" type="string" required="false" default="">
    ...
    <cfargument name="bridgeType" type="string" required="false" default="">
    <cfargument name="drawbridgeOnly" type="string" required="false" default="">
    <cfargument name="airDraftConcern" type="string" required="false" default="">
    <cfargument name="hasContact" type="string" required="false" default="">
    <cfargument name="hasCoordinates" type="string" required="false" default="">
    <cfargument name="verificationStatus" type="string" required="false" default="">
    <cfargument name="publicStatus" type="string" required="false" default="">
    ...
    <cftry>
      <cfscript>
        ...
        var bridgeSvc = createBridgeService();
        var response = {};

        switch (actionName) {
          case "filteroptions":
            response = bridgeSvc.getFilterOptions(filters);
            break;
          case "bridges":
            response = bridgeSvc.getBridgesApiModel(filters, resolveFpwBasePath());
            break;
          default:
            response = buildErrorResponse("Unsupported Great Loop bridge action.");
        }
      ...
      <cfcatch type="any">
        <cfoutput>#serializeJSON(buildErrorResponse("Unable to update bridge filters. Please try again."))#</cfoutput>
      </cfcatch>
    </cftry>
  ...
  <cffunction name="readFiltersFromUrl" access="private" returntype="struct" output="false">
    <cfscript>
      return {
        "q" = readUrlValue("q"),
        "routeSegment" = readUrlValue("routeSegment"),
        "routeVariant" = readUrlValue("routeVariant"),
        "waterway" = readUrlValue("waterway"),
        "stateProvince" = readUrlValue("stateProvince"),
        "bridgeType" = readUrlValue("bridgeType"),
        "drawbridgeOnly" = readUrlValue("drawbridgeOnly"),
        "airDraftConcern" = readUrlValue("airDraftConcern"),
        "hasContact" = readUrlValue("hasContact"),
        "hasCoordinates" = readUrlValue("hasCoordinates"),
        "verificationStatus" = readUrlValue("verificationStatus"),
        "publicStatus" = readUrlValue("publicStatus"),
        "limit" = "500"
      };
    </cfscript>
  </cffunction>
  ...
  <cffunction name="createBridgeService" access="private" returntype="any" output="false">
    <cfscript>
      try {
        return createObject("component", "api.v1.GreatLoopBridgesService").init();
      } catch (any svcPathError) {
        return createObject("component", "fpw.api.v1.GreatLoopBridgesService").init();
      }
    </cfscript>
  </cffunction>
